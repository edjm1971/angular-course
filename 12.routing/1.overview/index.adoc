...
Giving a URL to someone else should enable them to bring up the same _state_ in their browser.
...
* How to use parameterised routes where part of the URL is a variable.
